...
// Keyword/structural tokens that can appear in class attributes.
// (Bare-text scanning was removed — its overlap with CLASS_ATTR_RE produced
// phantom captures like `w-50` sneaking out of `w-50%`. If a class needs to
// be compiled without appearing in a `class="..."` attribute, list it in the
// `classes` file instead.)
...
module.exports = { extractClasses, parseClass, resolveViewport, diagnoseClass };
