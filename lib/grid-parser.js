...
const KEYWORD_MAP = {
  ...
  // Text alignment — start/end are logical (flip in RTL), preferred over left/right
  'text-start':  { prop: 'text-align', value: 'start' },
  'text-end':    { prop: 'text-align', value: 'end' },
  ...
  'fw-semibold': { prop: 'font-weight', value: '600' },
  'fw-bold':     { prop: 'font-weight', value: '700' },

  // Object fit
  'object-cover':   { prop: 'object-fit', value: 'cover' },
  'object-contain': { prop: 'object-fit', value: 'contain' },

  // Multi-declaration utilities (props: [prop, value] pairs)
  'truncate': { props: [
    ['overflow', 'hidden'],
